...
# Question n°1 : nombre d'items dans array / journalists.length => 379
...
# Question n°2 : nombre d'handle qui contiennent un numéro => 17

puts "Combien d'handles contiennent un numéro ?"
count = 0							  #def variable incrémentation
journalists.each do |email|           #each do = pour chaque element de mon array
	if email.match(/[0-9]/)           #match= matcher [correspond] 
		count +=1
	end
end
puts "#{count}"

# Question n°3 : nombre d'handle contenant les 4 lettres du prénom "Aude" à la suite (sans maj) => 3
...
# Question n°4 : nombre d'handle qui commencent par une majuscule => 209
...
# Question n°5 : nombre d'handle qui contiennent une majuscule => 215
...
# Question n°6 : nombre d'handle qui contiennent underscore => 72
...
# Question n°7 : trier la liste de handle par ordre alphabétique // attention, problème : tri d'abord ceux qui commencent par maj puis ceux par min. Utiliser .gsub ?
                                    
journalists.each do |mail|                                   
	puts "#{journalists.sort}"   
end                                                         

# Question n°8 : les 50 handles les plus courts de ce array // Attention, problème : pas trouvé comment choisir les 50 premiers
                                                            
 puts "Quels sont les 50 handles les plus courts de ce array ?"  

journalists2 = [] 										# Créer tableau vide pour y mettre le nouvel array
journalists.each do |mail| 
	journalists2 = journalists.sort_by {
    |object| 
    object.length
...
# Question n°9 : position dans l'array de la personne @epenser => 371
